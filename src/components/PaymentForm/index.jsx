                ...
                <div className="payment__border">
                    <div className="payment__address">
                        ...
                        <div className="validate__left-and-right">
                            ...
                            {errors?.name?.type === "min" && <p className="valid-form__message validate__left">Mật khẩu phải dài hơn 5 ký tự</p>}
                        </div>
                    ...
                    <div className="payment__info">
                        ...
                        <div onClick={handleSubmit(onSubmit)} className="payment__info-button">
                            {/* to={`/bill/${idUser}`} */}
                            <button className="btn btn-payment">Đặt Hàng</button>
                        </div>
                        <div className="payment__info-thanks">
                            Cảm ơn quý khách đã ủng hộ HD shop!
                        </div>
                    </div>
                </div>
            </div >
